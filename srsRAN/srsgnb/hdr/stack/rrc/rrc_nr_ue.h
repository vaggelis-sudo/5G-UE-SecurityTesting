...
extern bool hijack_rrc_setup_request;
extern bool hijack_rrc_reestablishment_request;
extern bool hijack_rrc_setup_complete;
extern bool hijack_rrc_reestablishment_complete;
extern bool hijack_rrc_reconfiguration_complete;
extern bool hijack_security_mode_complete;
extern bool hijack_ue_capability_information;
extern bool hijack_ul_information_transfer;
extern bool hijack_security_mode_command;
extern bool hijack_security_mode_command_disable;

typedef struct{
 string ue_ul_handle;
 string dl_reply;
 string command_mode;
 vector <string> dl_params;
} rrc_command;
 
typedef struct{
 vector <rrc_command> rrc_commands_before_aka;
 vector <rrc_command> rrc_commands_aka;
 vector <rrc_command> rrc_commands_after_aka;
} rrc_testset;

extern rrc_command r_command;
extern rrc_testset r_testset; 
...
public:
  ...
  void user_send_rrc_release(vector <string> params);
  void user_send_rrc_reject(vector <string> params);
  void user_send_rrc_security_mode_command(vector <string> params);
  void user_send_rrc_setup(vector <string> params);
  void user_send_rrc_ue_capability_enquiry(vector <string> params);
  void user_send_rrc_reestablishment(vector <string> params);
  void user_send_rrc_reconfiguration(vector <string> params);
  void user_send_rrc_resume(vector <string> params);
  void user_send_rrc_countercheck(vector <string> params);
  void user_send_mobility_from_nr(vector <string> params);

  void handle_hook(string ul_message);
  void dl_message_handle(string dl_message, vector <string> params);
