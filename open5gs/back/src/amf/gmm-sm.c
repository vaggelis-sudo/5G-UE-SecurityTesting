...
static void common_register_state(ogs_fsm_t *s, amf_event_t *e)
{
    ...
    case AMF_EVENT_5GMM_MESSAGE:
        ...
        case OGS_NAS_5GS_REGISTRATION_REQUEST:
            ...
            if(hijack_registration_request){
                user_ul_handle("registration_request", amf_ue, sess);
                ogs_info("Hijacked Registration Request!!!");
                break;
            }

            ogs_info("Registration request");
            gmm_cause = gmm_handle_registration_request(amf_ue, h, e->ngap.code, &nas_message->gmm.registration_request);
        ...
        case OGS_NAS_5GS_SERVICE_REQUEST:
            ...
            if(hijack_service_request){
                user_ul_handle("service_request", amf_ue, sess);
                ogs_info("Hijacked Service Request!!!");
                break;
            }

            ogs_info("Service request");
            gmm_cause = gmm_handle_service_request(amf_ue, h, e->ngap.code, &nas_message->gmm.service_request);
        ...
        case OGS_NAS_5GS_IDENTITY_RESPONSE:
            ...
            if(hijack_identity_response){
                user_ul_handle("identity_response", amf_ue, sess);
                ogs_info("Hijacked Identity Response!!!");
                break;
            }
            ...
            rv = gmm_handle_identity_response(amf_ue, &nas_message->gmm.identity_response);
        ...
        case OGS_NAS_5GS_5GMM_STATUS:
            ...
            if(hijack_gmm_status){
                user_ul_handle("gmm_status", amf_ue, sess);
                ogs_info("Hijacked 5GMM Status!!!");
                break;
            }

            ogs_warn("[%s] 5GMM STATUS : Cause[%d]", amf_ue->suci, nas_message->gmm.gmm_status.gmm_cause);
            OGS_FSM_TRAN(s, &gmm_state_exception);
            break;

        case OGS_NAS_5GS_DEREGISTRATION_REQUEST_FROM_UE:

            if(hijack_de_registration_request){
                user_ul_handle("deregistration_request", amf_ue, sess);
                ogs_info("Hijacked Deregistration Request!!!");
                break;
            }

            ogs_info("[%s] Deregistration request", amf_ue->supi);

            gmm_handle_deregistration_request(amf_ue, &nas_message->gmm.deregistration_request_from_ue);
            OGS_FSM_TRAN(s, &gmm_state_de_registered);
            break;

        case OGS_NAS_5GS_DEREGISTRATION_ACCEPT_TO_UE:

            if(hijack_de_registration_accept){
                user_ul_handle("deregistration_accept", amf_ue, sess);
                ogs_info("Hijacked Deregistration Accept!!!");
                break;
            }
        ...
        case OGS_NAS_5GS_CONFIGURATION_UPDATE_COMPLETE:
            ...
            if(hijack_configuration_update_complete){
                user_ul_handle("configuration_update_complete", amf_ue, sess);
                ogs_info("Hijacked Configuration Update Complete!!!");
                break;
            }
        ...
        case OGS_NAS_5GS_UL_NAS_TRANSPORT:
            ...
            if(hijack_ul_nas_transport){
                user_ul_handle("ul_nas_transport", amf_ue, sess);
                ogs_info("Hijacked Ul NAS Transport!!!");
                break;
            }
        ...
        case OGS_NAS_5GS_REGISTRATION_COMPLETE:
            ...
            if(hijack_registration_complete){
                user_ul_handle("registration_complete", amf_ue, sess);
                ogs_info("Hijacked Registration Complete!!!");
                break;
            }

            ogs_error("[%s] Registration complete in INVALID-STATE", amf_ue->supi);
    ...
    case AMF_EVENT_5GMM_TIMER:
        ...
        if(hijack_timer){
            user_ul_handle("timer_t3513", amf_ue, sess);
            ogs_info("Hijacked Timer t3513!!!");
            break;
        }
        ...
        case AMF_TIMER_T3555:
            ...
            if(hijack_timer){
                user_ul_handle("timer_t3555", amf_ue, sess);
                ogs_info("Hijacked Timer t3555!!!");
                break;
            }
        ...
        case AMF_TIMER_T3570:
            ...
            if(hijack_timer){
                user_ul_handle("timer_t3570", amf_ue, sess);
                ogs_info("Hijacked Timer t3570!!!");
                break;
            }
        ...
        case AMF_TIMER_T3522:
            ...
            if(hijack_timer){
                user_ul_handle("timer_t3522", amf_ue, sess);
                ogs_info("Hijacked Timer t3522!!!");
                break;
            }
...
void gmm_state_authentication(ogs_fsm_t *s, amf_event_t *e)
{
    ...
    case AMF_EVENT_5GMM_MESSAGE:
        ...
        case OGS_NAS_5GS_AUTHENTICATION_RESPONSE:
            ...
            if(hijack_authentication_response){
                user_ul_handle("authentication_response", amf_ue, sess);
                ogs_info("Hijacked Authentication Response!!!");
                break;
            }

            rv = gmm_handle_authentication_response(amf_ue, &nas_message->gmm.authentication_response);
        ...
        case OGS_NAS_5GS_AUTHENTICATION_FAILURE:
            ...
            if(hijack_authentication_failure){
                user_ul_handle("authentication_failure", amf_ue, sess);
                ogs_info("Hijacked Authentication Failure!!!");
                break;
            }
    ...
    case AMF_EVENT_5GMM_TIMER:
        ...
        case AMF_TIMER_T3560:
            ...
            if(hijack_timer){
                user_ul_handle("timer_t3560", amf_ue, sess);
                ogs_warn("Hijacked Timer t3560!!!");
                break;
            }
    ...
    case AMF_EVENT_5GMM_MESSAGE:
        ...
        case OGS_NAS_5GS_SECURITY_MODE_COMPLETE:
            ...
            if(hijack_security_mode_complete){
                user_ul_handle("security_mode_complete", amf_ue, sess);
                ogs_info("Hijacked Security Mode Complete!!!");
                break;
            }
        ...
        case OGS_NAS_5GS_SECURITY_MODE_REJECT:
            ...
            if(hijack_security_mode_reject){
                user_ul_handle("security_mode_reject", amf_ue, sess);
                ogs_info("Hijacked Security Mode Reject!!!");
                break;
            }

            ogs_warn("[%s] Security mode reject : Cause[%d]", amf_ue->supi, nas_message->gmm.security_mode_reject.gmm_cause);
        ...
        case OGS_NAS_5GS_5GMM_STATUS:
            ...
            ogs_warn("[%s] 5GMM STATUS : Cause[%d]", amf_ue->supi, nas_message->gmm.gmm_status.gmm_cause);
...
void gmm_state_initial_context_setup(ogs_fsm_t *s, amf_event_t *e)
{
    ...
    case AMF_EVENT_5GMM_TIMER:
        ...
        case AMF_TIMER_T3550:
            ...
            if(hijack_timer){
                user_ul_handle("timer_t3550", amf_ue, sess);
                ogs_info("Hijacked Timer t3550!!!");
                break;
            }
